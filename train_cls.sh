...
python3 strawml/cross_validate_straw_model.py --model convnextv2 --lr 0.00003972055115132435 --batch_size 8 --image_size 672 208 --id best_convnextv2 --num_hidden_layers 3 --use_sigmoid --balanced_dataset --data_subsample 1.0 --optim adam --augment_probability 0.0 --cont --use_wce --hpc --epochs 150 --folds 4 --pretrained --data_path train.hdf5