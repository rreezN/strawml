...
python3 strawml/train_straw_model.py --model convnextv2 --load_model models/convnextv2 --batch_size 12 --lr 0.0000446831361387714 --image_size 672 208 --id new_best_convnextv2 --num_hidden_layers 3 --use_sigmoid --balanced_dataset --data_subsample 1.0 --optim adam --augment_probability 0.0 --cont --use_wce --hpc --epochs 150 --pretrained --data_path train.hdf5