...
python3 strawml/cross_validate_straw_model.py --data_path data/interim/chute_detection.hdf5 --lr 0.00001 --epochs 25 --cont --folds 5 --model vit --pretrained --image_size 384 384 --greyscale --id grey_gpua100 --hpc
