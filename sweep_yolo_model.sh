...
python strawml/cross_validate_yolo.py --path /work3/s194247/yolo_format_bbox_chute_whole_4fold --test_data_yaml /work3/s194247/test_data_set.yaml --id tbma63io # straw whole
